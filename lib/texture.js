...
Texture.contextMethods = {
    ...
    setTextureParameters(context, params) {
        ...
        context._log(`set_texture_parameters(${keys})`);
    ...
    setUnpackFlipY(context, value) {
        context._log(`set_unpack_flip_y(${value})`);
        context.handle().pixelStorei(UNPACK_FLIP_Y_WEBGL, value);
    },
};
