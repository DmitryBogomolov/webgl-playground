...
export class Context {
    ...
    createProgram(vertexShaderSource, fragmentShaderSource) {
        const program = new Program(this, vertexShaderSource, fragmentShaderSource);
        program.init();
        return program;        
    }

    createBuffer() {
        const buffer = new Buffer(this, ARRAY_BUFFER);
        buffer.init();
        return buffer;
    }

    createIndexBuffer() {
        const buffer = new Buffer(this, ELEMENT_ARRAY_BUFFER);
        buffer.init();
        return buffer;
    }

    createVAO() {
        const vao = new VertexArrayObject(this);
        vao.init();
        return vao;
    }
