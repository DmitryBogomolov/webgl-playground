import {
    ...
    eq3, isZero3, isUnit3, vec3str, clone3, neg3, inv3, len3, sqrlen3, norm3, dir3, dist3, sqrdist3,
...
describe('vec3', () => {
    ...
    it('vec3str', () => {
        expect(vec3str({ x: 1, y: 2, z: 3 })).toEqual('(1, 2, 3)');
        expect(vec3str({ x: 2.1234, y: 3.0023, z: 4.12 })).toEqual('(2.1234, 3.0023, 4.12)');
    });
